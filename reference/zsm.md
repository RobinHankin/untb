...
Returns a vector of size `J` showing the probability of the stationary
abundance being \\1,\ldots,J\\.

## References

A. J. McKane and others 2004. “Analytic solution of Hubbell's model of
local community dynamics”. *Theoretical Population Biology* 65:67-73
...
The function uses [`lgamma()`](https://rdrr.io/r/base/Special.html) to
